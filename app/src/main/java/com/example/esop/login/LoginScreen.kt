                    ...
                    response.data?.let { user ->
                        ...
                        appPrefs.saveUser(
                            UserDataStore(
                                ...
                                processGroupId = user.processGroupId?.toIntOrNull() ?: 0,
                                organizationId = user.organizationId?.toIntOrNull() ?: 0,
...
//
//
////                scope.launch { appPrefs.saveDepartment("Operation")}
////                appPrefs.saveUser(
////                    UserDataStore(
////                        id = "123456789",
////                        name = "Ajit",
...
//
//
////                        appPrefs.saveDepartment("Operation")
////                        scope.launch { appPrefs.saveDepartment("Operation")}
////                        appPrefs.saveUser(
////                            UserDataStore(
////                                id = user.id.toString(),
